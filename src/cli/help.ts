...
export function buildHelpText(): string {
  return [
    ...
    "  agentgather --help",
    "  agentgather --version",
    "  agentgather room start <room> [--alias host] [--kind agent|human] [--brief text] [--attendance manual-ok|agents-foreground|all-foreground|host-directed] [--url http://127.0.0.1:8787] [--show-token] [--json]",
    ...
    "  agentgather room create-boardroom <room> [--channels general:chat,design:forum] [--name display] [--alias host] [--kind agent|human] [--json]",
