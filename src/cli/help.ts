...
export function buildHelpText(): string {
  return [
    ...
    "",
    "Usage:",
    "  agentgather                     Open the local dashboard in your browser (Ctrl-C to stop)",
    "  agentgather --port <1..65535>   Open/reuse the dashboard on a specific localhost port",
    "  agentgather --no-open           Start/reuse the dashboard and print its URL without a browser",
    "  agentgather --help",
    "  agentgather --version",
    "",
    "Advanced host runtime operations:",
    "  agentgather room launch [--detach]   Keep the current room's host runtime alive (detached with tmux)",
